...
<script type="text/javascript">
	...
	$(function(){
		...
		$(".remarkbody").on("mouseover",".myHrefe",function () {
			$(this).children("span").css("color","#FF0000");
		})
		$(".remarkbody").on("mouseout",".myHrefe",function(){
			$(this).children("span").css("color","#E6E6E6");
		})

		$(".remarkbody").on("mouseover",".myHrefd",function () {
			$(this).children("span").css("color","#FF0000");
		})
		$(".remarkbody").on("mouseout",".myHrefd",function(){
			$(this).children("span").css("color","#E6E6E6");
		})
			...
			$.ajax({
				...
				data:{
					...
					if(data.success){
						var html="";
						<!-- 备注 -->
						html+='<div id="'+data.c.id+'" class="remarkDiv" style="height: 60px;">';
						html+='<img title="zhangsan" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
						html+='<div style="position: relative; top: -40px; left: 40px;" >';
						html+='<h5 id="n'+data.c.id+'">'+data.c.noteContent+'</h5>';
						html+='<font color="gray">线索</font> <font color="gray">-</font> <b>${c.fullname}-${c.appellation}</b> <small style="color: gray;" id="s\'+n.id+\'"> '+(data.c.editFlag==0?data.c.createTime:data.c.editTime)+'  由  '+(data.c.editFlag==0?data.c.createBy:data.c.editBy)+'</small>';
						html+='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
						html+='<a class="myHrefe" href="javascript:void(0);" onclick="editRemark(\''+data.c.id+'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>';
						html+='&nbsp;&nbsp;&nbsp;&nbsp;';
						html+='<a class="myHrefd" href="javascript:void(0);" onclick="deleteRemark(\''+data.c.id+'\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>';
						html+='</div>';
						html+='</div>';
						html+='</div>';


						$("#remarkSubDody").after(html);
						//显示
						$("#cancelAndSaveBtn").hide();
						$("#remark").val("");
						//设置remarkDiv的高度为130px
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data,function (i,n) {
					...
					html+='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
					html+='<a class="myHrefe" href="javascript:void(0);" onclick="editRemark(\''+n.id+'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>';
					html+='&nbsp;&nbsp;&nbsp;&nbsp;';
					html+='<a class="myHrefd" href="javascript:void(0);" onclick="deleteRemark(\''+n.id+'\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>';
					html+='</div>';
					html+='</div>';
					html+='</div>';
				})
...
<body>
	...
	<!-- 备注 -->
	<div style="position: relative; top: 40px; left: 40px;" class="remarkbody">
		<div class="page-header" id="remarkSubDody">
			<h4>备注</h4>
		</div>
