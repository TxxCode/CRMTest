...
public class ClueServiceImpl implements ClueService {
    ...
    public PageinationVO<Clue> getCluePageList(Map<String, Object> map) {
        ...
        //根据页码查询数据
        List<Clue> cList = clueDao.getPageListByCondition(map);

        //放入vo中
        PageinationVO<Clue> vo = new PageinationVO<Clue>();
    ...
    public Map<String, Object> getUserListAndClue(String id) {
        ...
        List<Clue> cList = clueDao.getClueById(id);
    ...
    public boolean updateClue(Clue c) {
        ...
        int count = clueDao.updateClue(c);
